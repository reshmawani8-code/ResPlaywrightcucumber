...
export default class AllureCucumberReporter extends Formatter {
  ...
  emitTestRunHookGlobalError(name, error) {
    this.allureRuntime.applyGlobalRuntimeMessages([toGlobalErrorMessage(name, getMessageAndTraceFromError(this.toError(error)))]);
  }
  toError(error) {
  ...
  onTestStepFinished(data) {
    ...
    if (step.hookId) {
      ...
      if (error) {
        this.allureRuntime.applyGlobalRuntimeMessages([toGlobalErrorMessage(this.getHookName(step.hookId), getMessageAndTraceFromError(error))]);
      }
